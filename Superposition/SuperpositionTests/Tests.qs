namespace Quantum.Superposition
{
    ...
    // ------------------------------------------------------
    operation T04_BellPair_Test () : ()
    {
        body
        {
            AssertEqualOnZeroState(2, BellPair, BellPair_Reference);
        }
    }

    // ------------------------------------------------------
    operation T05_GHZ_State_Test () : ()
    {
        body
        {
            // for N = 1 it's just |+〉
            AssertEqualOnZeroState(1, GHZ_State, PlusState_Reference);
            // for N = 2 it's Bell pair
            AssertEqualOnZeroState(2, GHZ_State, BellPair_Reference);
            for (n in 3..9) {
    ...
    // ------------------------------------------------------
    operation T06_AllBasisVectorsSuperposition_Test () : ()
    {
        body
        {
            // for N = 1 it's just |+〉
    ...
    // ------------------------------------------------------
    operation T07_ZeroAndBitstringSuperposition_Test () : ()
    {
        body
        {
            ...
            AssertEqualOnZeroState(2, ZeroAndBitstringSuperposition(_, [true; true]), BellPair_Reference);
    ...
    // ------------------------------------------------------
    operation T08_TwoBitstringSuperposition_Test () : ()
    {
        body
        {
            // compare with results of previous operations
            AssertEqualOnZeroState(1, TwoBitstringSuperposition(_, [true], [false]), PlusState_Reference);
            AssertEqualOnZeroState(2, TwoBitstringSuperposition(_, [false; false], [true; true]), BellPair_Reference);
    ...
    // ------------------------------------------------------
    operation T09_WState_PowerOfTwo_Test () : ()
    {
        body
        {
            ...
            AssertEqualOnZeroState(4, WState_PowerOfTwo, WState_Arbitrary_Reference);
            AssertEqualOnZeroState(8, WState_PowerOfTwo, WState_Arbitrary_Reference);
            AssertEqualOnZeroState(16, WState_PowerOfTwo, WState_Arbitrary_Reference);
        }
    }

    // ------------------------------------------------------
    operation T10_WState_Arbitrary_Test () : ()
    {
        body
        {
            // separate check for N = 1 (return must be |1〉)
            ...
            AssertEqualOnZeroState(2, WState_Arbitrary, WState_Arbitrary_Reference);
            AssertEqualOnZeroState(4, WState_Arbitrary, WState_Arbitrary_Reference);
            AssertEqualOnZeroState(8, WState_Arbitrary, WState_Arbitrary_Reference);
            AssertEqualOnZeroState(16, WState_Arbitrary, WState_Arbitrary_Reference);
